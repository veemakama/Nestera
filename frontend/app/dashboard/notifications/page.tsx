...
const INITIAL: Notification[] = [
  {
    ...
    body: 'Your deposit of 500 USDC to Flexible Savings was confirmed.',
    time: '2 min ago',
    read: false,
  },
  {
    ...
    type: 'governance',
    title: 'New Proposal',
    body: 'Proposal #12 — Increase APY cap to 12% is now open for voting.',
    time: '1 hr ago',
    read: false,
  },
  {
    ...
    body: "You've reached 50% of your Emergency Fund goal!",
    time: '3 hr ago',
    read: false,
  },
  {
    ...
    body: 'Scheduled maintenance on Apr 27 from 02:00–04:00 UTC.',
    time: 'Yesterday',
    read: true,
  },
  {
    ...
    body: '200 USDC withdrawn from Locked Savings to your wallet.',
    time: '2 days ago',
    read: true,
  },
  {
    ...
    body: 'Proposal #11 — Fee reduction has passed with 78% approval.',
    time: '3 days ago',
    read: true,
  },
];
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col gap-3">
        ...
        {visible.length === 0 && (
          <p className="text-[#5e8c96] text-sm py-8 text-center">
        ...
        {visible.map((n) => {
          ...
          return (
            ...
            >
              ...
              {!n.read && <span className="w-2 h-2 rounded-full bg-cyan-400 shrink-0 mt-1.5" />}
            </div>
          );
        })}
      </div>
